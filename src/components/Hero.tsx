...
export default function Hero() {
  return (
    <section
      className=' bg-[url("https://res.cloudinary.com/dfltsy2ov/image/upload/v1753623377/background/vw9unfyoolwjyhvu8yt5.avif")] bg-cover bg-center h-screen bg-fixed relative w-screen'
      dir="ltr"
    >
      <div className="absolute flex items-center h-full  bg-[#000a] w-screen">
        <div className=" text-white left-0 ml-8 mt-32 items-center hidden lg:flex ">
          ...
          >
            ...
            <div className="mt-1 ml-3 text-2xl" style={{ letterSpacing: 2 }}>
              <AnimatedText
                text="real estate"
                once={false}
                lang="en"
