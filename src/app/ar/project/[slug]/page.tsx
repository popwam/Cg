...
export default function ProductPage(props: Props) {
  ...
  const navLinks = [
    ...
    { label: "English", href: `/project/${product.slug}`, issee: "no" },
  ];
  ...
  const jsonLd = {
    ...
    url: `https://capitalgate.com/ar/project/${product.slug}`,
  };
  ...
  return (
    ...
    >
      <Navbar
        navLinks={navLinks}
        logoTop={"https://res.cloudinary.com/dfltsy2ov/image/upload/v1753623049/logo/agfrf31kpws0sxgxkudk.avif"}
        logoTextTop={"https://res.cloudinary.com/dfltsy2ov/image/upload/v1753623053/logo/fcygqklzlehiiori2dic.avif"}
        logoBotoom={"https://res.cloudinary.com/dfltsy2ov/image/upload/v1753623048/logo/t6vdoxqehyrikxe4tvhy.avif"}
        logoTextBotoom={"https://res.cloudinary.com/dfltsy2ov/image/upload/v1753623051/logo/ritntst37ef2kpb7aohv.avif"}
      ...
      <div className="w-screen min-h-[50vh] md:h-[85vh] relative">
        <div className="relative lg:absolute h-[50vh] md:h-[85vh] w-screen lg:top-0 lg:left-0 lg:right-0 z-0 ">
          ...
          <div className="w-[100px] h-[100px] md:w-[130px] md:h-[130px] bg-gray-50 bottom-4 lg:bottom-12 start-5 lg:start-16 absolute z-10 flex items-center p-3 rounded-full shadow">
            <Link href={`/ar/developer/${product.linkdeve}`}>
              <Image
        ...
        <div className="z-10 relative md:absolute w-full md:w-[350px] md:end-28 md:top-1/2 lg:-translate-y-1/2">
          ...
          >
            <p className={`text-sm text-gray-700 capitalize`}>
              ...
              ولتحديد موعد للزيارة، سجل بيانات الاتصال الخاصة بك وسنتصل بك في
              أقرب وقت ممكن.
            </p>
        ...
        <div className="lg:col-start-8 lg:col-end-11 flex items-center order-1">
          {product.price && (
            <div className="max-w-md mx-auto rounded-xl shadow-lg bg-white p-6 text-center">
              <p className="text-teal-500 font-medium mb-2">السعر </p>
              ...
              {product.updated && (
                <p className="text-sm text-gray-500 mb-4">
                  {product.updated}&nbsp;&nbsp;|&nbsp;
                  <span className="text-blue-600">المرحلة الحالية</span>
                </p>
              )}
              <div className="flex justify-between items-center text-center text-blue-900 font-semibold my-4">
                ...
                >
                  <p className="text-sm text-gray-500">سنوات التقسيط</p>
        ...
        {relatedProjects.map((product) => (
          ...
          >
            ...
            >
              ...
              >
                <Link href={`/developer/${product.linkdeve}`} className="z-10">
                  ...
                  {product.price && product.price !== "---" ? (
                    <div>
                      {product.downpayment && product.years && (
                        <p>
                          مقدم {product.downpayment}% , {product.years} سنوات
                        </p>
                      )}
