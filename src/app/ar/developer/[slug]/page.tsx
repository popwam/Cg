...
export default function DeveloperPage(props: Props) {
  ...
  const jsonLd = {
    ...
    url: `https://capitalgate.com/ar/developer/${developerslug}`,
  };
  ...
  return (
    <>
      ...
      >
        ...
        <div className="max-w-6xl mx-auto p-6 rounded-xl flex flex-col md:flex-row gap-8 items-start mb-[10%] pt-[15vh] md:pt-[10%]">
