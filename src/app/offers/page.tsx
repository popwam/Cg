...
export default function OffersPage() {
  ...
  const navLinks = [
    ...
    { label: "Offers", href: "/offers", activate: true },
      ...
      >
        ...
        <div className="relative px-4 pb-24 pt-8 space-y-6 my-[13vh]">
          ...
          <button
            ...
            className="fixed bottom-4 right-4  z-50 px-4 py-2 bg-blue-600 text-white rounded-md shadow-lg"
          >
            <FaFilter />
          </button>
          ...
          {showFilters && (
            ...
            >
              <div className="p-4 relative h-full overflow-y-auto">
                ...
                <h2 className="text-xl font-bold mb-4">Filter offers</h2>

                {/* Areas */}
                <div className="mb-4">
                  <label className="block font-semibold mb-1">Areas</label>
                ...
                <button
                  ...
                  className="mt-2 bg-gray-200 px-8 py-2 rounded-md text-sm"
                >
                  Reset filters
                </button>
              </div>
